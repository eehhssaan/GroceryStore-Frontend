    ...
    <div className="pb-16 lg:pb-0 xl:pb-0 bg-white">
      <div className="mx-auto max-w-screen-2xl px-4 sm:px-10">
        <div className="mx-auto max-w-screen-2xl px-4 sm:px-10 bg-gray-50 shadow-sm border border-gray-50 rounded-lg">
          <div className=" flex grid grid-cols-1 md:grid-cols-1 xl:grid-cols-1 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-8 items-center justify-center">
            ...
            <div className="flex col-span-1 justify-center">
              <p className="text-base leading-7 font-medium block m-3">
                Call Us Today!
              </p>
              <h5 className="text-2xl font-bold text-emerald-500 leading-7 m-3">
                +012345-67900
              </h5>
            </div>
